...
## creates a chart showing Global_active_power frequency over these 2 days. The
## chart plot1.png is created in the working directory.
##
...
plot1 <- function() {
      ...
      ## Create the chart
      par(mfrow = c(1,1))
      hist(s1$Global_active_power, col = "red", main = "Global Active Power", 
